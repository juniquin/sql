...
-- TEST
-- exec rate.usp_GSK_KN_SourceRates_v1 'Ocean LCL', 'Accessorial', 'Origin', 'K50401'


ALTER PROCEDURE rate.usp_GSK_KN_SourceRates_v1
	(
...
set @query = N'EXEC rate.usp_GSK_KN_Rates_Create_View_v1 '''+@mode+''', '''+@cat+''', '''+@accgroup+''' '
exec sp_executesql @query

if object_id('tempdb..#newrates') is not null drop table #newrates
select * into #newrates from rate.vw_GSK_KN_SourceRates_Temp_v1
